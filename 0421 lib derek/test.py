...
def pick_and_place_tagx(team, tag_name, H_tic_w, i):
    ...
    if team == "red":
        ...
        q_static_up_ref = np.array([-0.03074419, -0.10781547, 0.23909529, -2.18551048, 0.02920031, 2.08056687, 2.88118093])
        q_tower_up_ref_side = np.array([-0.86048895, 0.4852505, 0.26522349, -1.35016221, 1.28036102, 0.99785097, -1.08143])
...
def pick_and_place_tag6(team, H_tic_w, i, is_first_box=False):
    ...
    if team == "red":
        ...
        q_static_up_ref = np.array([0.19376103, 0.03519338, 0.23693431, -2.02041482, -0.00933215, 2.05461371, -1.56212044])
        q_tower_up_ref_up = np.array([-0.1333603, 0.11358311, -0.16514736, -1.90954666, 0.02063303, 2.02083333, 0.47894547])
